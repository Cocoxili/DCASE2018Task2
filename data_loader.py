...
class Freesound_logmel(Dataset):
    ...
    def _random_selection(self, file_path):
        ...
        input_frame_length = int(self.config.audio_duration * 1000 / self.config.hop_length)
        # Read and Resample the audio
        ...
        if logmel.shape[1] > input_frame_length:
            ...
            data = np.pad(logmel, (offset, input_frame_length - logmel.shape[1] - offset), "constant")
        return data
